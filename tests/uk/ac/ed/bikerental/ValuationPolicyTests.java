...
public class ValuationPolicyTests {
    ...
    void firstTest() {
        ...
        testbike.store.setDepreciationRate(new BigDecimal("0.1"));
    ...
    void secondTest() {
        ...
        testbike.store.setDepreciationRate(new BigDecimal("0.2"));
    ...
    void thirdTest() {
        ...
        testbike.store.setDepreciationRate(new BigDecimal("0.3"));
